...
excerpt: "In this post I will show you a functional approach for testing named exported recursive functions using Jest."
---
...
![Recursive function test failed](/content/posts/testing-exported-functions-using-jest/recursive-function-test-failed.png)
