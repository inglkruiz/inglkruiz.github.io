...
---
import { Code } from '../../../components/astro-overrides'
...
<Code lang="bash" withLineNumbers={false} code={
...
<Code lang="json" codeStyle="--start: 6;" code={
`{
  "scripts": {
...
![Typescript error assign string to number](/content/posts/apprentices-will-not-understand-typescript/typescript-error-assign-string-to-number.png)
...
![Google chrome debugging typescript](/content/posts/apprentices-will-not-understand-typescript/google-chrome-debugging-typescript.png)
...
![Jest init answers](/content/posts/apprentices-will-not-understand-typescript/jest-init-answers.png)
...
<Code lang="json" codeStyle="--start: 10;" code={
`{
  "scripts": {
    "start": "parcel serve ./src/index.html",
    "build": "parcel build ./src/index.html",
...
![Parcel and Jest running in different terminals](/content/posts/apprentices-will-not-understand-typescript/parcel-jest-run-terminal.png)
